...
def view_appointment
    puts "Alrighty, let me check my records. This might take a while. Hah. Kidding. I'm a machine. I can pretty much learn how to master the violin faster than it takes you to read this sentence. Here's the appointment you made: #{$dog.appointments[-1].time}"
    # binding.pry  
end 
...
def change_appointment
    ...
    last_appointment = $dog.appointments[-1]
    last_appointment.time = change_time(last_appointment)
    last_appointment.save
     puts "Here's you're new appointment time:"
     puts last_appointment.time 
end 
# The more I call this method ^, the more the "last appointment" mutates 
# into this weird thing full of back slashes

def change_time(appointment)
    time_array = appointment.time.split(' ')
